  ...
  const reasons = (c) => (
    <ul className="why">
      {c.kind === "total" ? (
        ...
        <>
          <li>Model has this side winning {(c.pModel * 100).toFixed(0)}% outright, {(c.edge * 100).toFixed(1)}
              points above the market across {c.res.count} {c.res.count === 1 ? "book" : "books"}.</li>
